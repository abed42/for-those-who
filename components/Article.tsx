...
export const LikeSvg = ({ style }: { style?: any }) => {
  return (
...
export const DislikeSvg = ({ style }: { style?: any }) => {
  return (
    <Svg style={style} viewBox="0 0 512 512">
    ...
    <View style={styles.feedbackHeader}>
      <View
        style={{
          ...
          backgroundColor:
            actionType === ActionType.LIKE ? "#0029FF" : "#F9325D",
        }}
      >
        {actionType === ActionType.LIKE ? (
          <LikeSvg style={styles.secondaryLikedBtn} />
        ) : (
          <DislikeSvg style={styles.secondaryDislikedBtn} />
        )}
      </View>

      <Text style={{ width: "80%" }}>
        {actionType === ActionType.LIKE
          ? `You seem to like this piece of reading. Tell me why, so we can get to know you better.`
          : `You seem to not like this piece of reading. Tell us why, so we can get to know you better.`}
      </Text>
